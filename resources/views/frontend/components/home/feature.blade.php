					...
					<div class="col-md-4 p-3">
						<div class="card h-100 shadow">
							...
							<div class="card-img-wrapper">
								<a href="http://127.0.0.1:8000/post/10">
									<div class="card-img-top" style="background-image: url('https://dummyimage.com/600x400/000/fff');">
										<div class="overlay">
							...
							<div class="card-body d-flex p-4 flex-column">
								...
								<h2 class="card-title h5">
									<a href="http://127.0.0.1:8000/post/10" class="text-decoration-none text-dark hover-primary">
								...
								<p class="card-text text-muted">
									Conference on modern education techniques and policies
								</p>
								...
								<div class="d-flex justify-content-between align-items-center py-3">
                                    <a href="http://127.0.0.1:8000/post/3" class="btn btn-outline-primary btn-sm">
                                        Read More
